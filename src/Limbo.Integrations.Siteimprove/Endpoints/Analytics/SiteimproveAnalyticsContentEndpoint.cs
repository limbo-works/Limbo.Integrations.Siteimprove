...
using Limbo.Integrations.Siteimprove.Responses.Analytics.Content;
...
namespace Limbo.Integrations.Siteimprove.Endpoints.Analytics {
    ...
    public class SiteimproveAnalyticsContentEndpoint {
        ...
        internal SiteimproveAnalyticsContentEndpoint(SiteimproveHttpService service, SiteimproveAnalyticsEndpoint analytics) {
            Service = service;
            Analytics = analytics;
        }
