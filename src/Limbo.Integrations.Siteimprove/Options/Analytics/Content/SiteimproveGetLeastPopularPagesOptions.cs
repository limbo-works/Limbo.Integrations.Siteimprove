...
namespace Limbo.Integrations.Siteimprove.Options.Analytics.Content {
    ...
    public class SiteimproveGetLeastPopularPagesOptions : SiteimproveAnalyticsGetPeriodOptionsNope {
        ...
        /// </summary>
        public SiteimproveGetLeastPopularPagesOptions() { }

        /// <summary>
        /// Initializes a new instance with the specified <paramref name="siteId"/>.
        /// </summary>
        /// <param name="siteId">The ID of the site.</param>
        public SiteimproveGetLeastPopularPagesOptions(long siteId) {
            SiteId = siteId;
        }
        ...
        public SiteimproveGetLeastPopularPagesOptions(long siteId, int page, int pageSize) {
            SiteId = siteId;
            Page = page;
            PageSize = pageSize;
        }
        ...
        public override IHttpRequest GetRequest() {
            ...
            return HttpRequest.Get($"/v2/sites/{SiteId}/analytics/content/least_popular_pages", GetQueryString());
