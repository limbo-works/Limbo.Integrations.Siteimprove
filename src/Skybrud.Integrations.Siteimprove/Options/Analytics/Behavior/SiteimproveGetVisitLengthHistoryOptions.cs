...
namespace Skybrud.Integrations.Siteimprove.Options.Analytics.Behavior {
    ...
    public class SiteimproveGetVisitLengthHistoryOptions : SiteimproveAnalyticsGetPeriodOptionsNope {
        ...
        /// </summary>
        public SiteimproveGetVisitLengthHistoryOptions() { }
        ...
        public override IHttpRequest GetRequest() {
            ...
            return HttpRequest.Get($"/v2/sites/{SiteId}/analytics/behavior/visit_length/history", GetQueryString());
