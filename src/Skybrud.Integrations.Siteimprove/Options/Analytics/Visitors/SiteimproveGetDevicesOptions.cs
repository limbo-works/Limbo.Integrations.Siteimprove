...
namespace Skybrud.Integrations.Siteimprove.Options.Analytics.Visitors {

    public class SiteimproveGetDevicesOptions : SiteimproveAnalyticsGetPeriodOptionsNope {
