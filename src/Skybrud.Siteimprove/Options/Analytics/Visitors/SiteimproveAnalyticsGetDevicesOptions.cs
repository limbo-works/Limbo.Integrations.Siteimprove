...
namespace Skybrud.Siteimprove.Options.Analytics.Visitors {
    
    public class SiteimproveAnalyticsGetDevicesOptions : IGetOptions {
        ...
        /// </summary>
        public SiteimproveAnalyticsGetDevicesOptions() { }

        /// <summary>
        /// Initializes a new instance with the specified <code>siteId</code>.
        /// </summary>
        /// <param name="siteId">The ID of the site.</param>
        public SiteimproveAnalyticsGetDevicesOptions(int siteId) {
            SiteId = siteId;
        }
        ...
        public SiteimproveAnalyticsGetDevicesOptions(int siteId, int page, int pageSize) {
            SiteId = siteId;
            Page = page;
            PageSize = pageSize;
        }
        ...
        public SiteimproveAnalyticsGetDevicesOptions SetPeriod(DateTime day) {
        ...
        /// <returns>Returns the options instance for method chaining.</returns>
        public SiteimproveAnalyticsGetDevicesOptions SetPeriod(DateTime from, DateTime to) {
